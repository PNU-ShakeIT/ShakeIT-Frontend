...
public class ProfileModel {
    ...
    @SerializedName("cmit_NM")
    private String cmit_NM;

    @SerializedName("cmits")
    ...
    @SerializedName("bth_GBN_NM")
    private String bth_GBN_NM;

    @SerializedName("bth_DATE")
    private String bth_DATE;

    @SerializedName("job_RES_NM")
    private String job_RES_NM;

    @SerializedName("reele_GBN_NM")
    private String reele_GBN_NM;

    @SerializedName("sex_GBN_NM")
